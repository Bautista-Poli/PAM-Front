...
const fallbackLogoLocal ="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/Escudo_del_C_A_River_Plate.svg/968px-Escudo_del_C_A_River_Plate.svg.png";
const fallbackLogoVisita ="https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Escudo_del_Club_Atl%C3%A9tico_Sarmiento_de_Jun%C3%ADn.svg/250px-Escudo_del_Club_Atl%C3%A9tico_Sarmiento_de_Jun%C3%ADn.svg.png";
        ...
        <View style={styles.card}>
          {(data.league || data.match_date) && (
            <View style={styles.cardHeader}>
              ...
              {data.match_date ? <Text style={styles.date}>{data.match_date}</Text> : null}
            </View>
          )}
          ...
          <View style={styles.row}>
            ...
            <View style={styles.teamBlock}>
              <Image source={{uri:fallbackLogoLocal}} style={styles.logo} resizeMode="contain" />
            ...
            {/* Visitante */}
            <View style={styles.teamBlock}>
              <Image source={{uri:fallbackLogoVisita}} style={styles.logo} resizeMode="contain" />
              <Text style={styles.teamName} numberOfLines={1}>
