...
const tablaLigaArgentina: EquipoTabla[] = [
  ...
  { nombre: "Talleres (Córdoba)", puntos: 48, pj: 27, gf: 34, gc: 27, dg: 7 },
  ...
  { nombre: "Sarmiento (Junín)", puntos: 26, pj: 27, gf: 18, gc: 28, dg: -10 },
